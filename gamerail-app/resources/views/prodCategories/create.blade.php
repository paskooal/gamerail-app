...
@section("content")
<form data-parsley-validate action="{{ route('prodCategories.store') }}" id="form" method="POST" class="max-w-3xl mx-auto p-6">
    @csrf
    ...
    <div class="flex flex-col items-center">
        ...
        <x-link class="mt-3" href="{{ route('prodCategories.index') }}" :value="__('Voltar à Tabela')" />
    </div>
</form>
@endsection
